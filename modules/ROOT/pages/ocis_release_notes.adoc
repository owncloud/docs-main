...
* Add Strict-Transport-Security via proxy: https://github.com/owncloud/ocis/pull/11896[#11896]
* Dependency updates: https://github.com/owncloud/ocis/pull/11992[#11992]
