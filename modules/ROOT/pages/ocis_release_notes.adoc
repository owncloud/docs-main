...
* Web: {web-releases-url}/v11.1.3[Changelog for ownCloud Web 11.1.3, window=_blank]

[discrete]
=== General Information

This Infinite Scale release provides new functionalities and some bug fixes. See the xref:next@ocis:ROOT:migration/upgrading-ocis.adoc[Upgrading Infinite Scale] documentation for details how to upgrade.
