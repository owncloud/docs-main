...
* https://github.com/owncloud/web-extensions[WebUI extensions] can be added manually to the default WebUI. See the link for available extensions and the
...
* `drawio` has been removed from the embedded WebUI but provided as WebUI extension.
