...
Negative performance impact when `file_storage.save_version_metadata` is enabled has been removed. https://github.com/owncloud/core/pull/41069[#41069]

=== Proper Error Handling when Deleting Users or Groups

In case of an error when deleting an user or a group no proper feedback was given to the user. This is now fixed. https://github.com/owncloud/core/pull/41077[#41077]
...
As soon as an user has rejected a share no activities within this share are now reported via the activity app. https://github.com/owncloud/core/pull/41078[#41078]
...
=== Image Dimension Validation on Avatar Upload and Previews Generation

For avatar and previews generation we now do not accept images exceeding specific dimensions. https://github.com/owncloud/core/pull/41175[#41175]

=== Replace the isAdmin Implementation

Instead of asking the backends for the groups an user belongs to, we now get the admin group and list the members to detect if user is admin or not. https://github.com/owncloud/core/pull/41171[#41171]
...
* Fix: Input validation when setting the displayname of an user or self. https://github.com/owncloud/core/pull/41172[#41172]
...
* {oc-marketplace-url}/apps/files_classifier[Document Classification]: 1.5.0
