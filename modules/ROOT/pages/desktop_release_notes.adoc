...
The ownCloud Desktop App is now available in version 6.0.3! +
...
Refer to the full change log for a list of bug fixes and changes at {desktop-releases-url}v6.0.3[GitHub, window=_blank].

[discrete]
=== Notable Changes

* Change: Third party upgrades in distributed binaries: https://github.com/owncloud/client/pull/12364[#12364]
* Security: Fixing medium security vulnerability in password input handling: https://github.com/owncloud/client/pull/12430[#12430]
...
The ownCloud Desktop App is now available in version 6.0.2! +
We strongly recommend updating the Desktop App to the latest available version so that you can access and experience a range of new features and security fixes. Users with an Enterprise subscription are entitled to receive dedicated support.

Refer to the full change log for a list of bug fixes and changes at {desktop-releases-url}v6.0.2[GitHub, window=_blank].

[discrete]
=== Notable Fixes

* Security: Fixing high security vulnerability in MacOS client: https://github.com/owncloud/client/pull/12379[#12379]
...
* Bugfix: Reverting UTF-8 normalisation change: https://github.com/owncloud/client/pull/12304[#12304]
* Bugfix: Fix VFS checkbox in folder wizard: https://github.com/owncloud/client/pull/12305[#12305]
* Change: Move to trash-bin is enabled now by default: https://github.com/owncloud/client/pull/12338[#12338]
...
* Desktop Apps built for the particular Ubuntu 20.04 and Debian 11 releases are currently available but not functional. All other releases are unaffected and function properly.
