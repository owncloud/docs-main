...
Note that at the moment **no branching** is necessary for the docs-main repo as only the `master` branch is used that appears as `next` in the documentation.
...
* When 4.x (core) is finally out, the 4.x-2 branch can be archived, see step 3 in [Create a New Version Branch](https://github.com/owncloud/docs-main/blob/master/docs/new-version-branch.md)
